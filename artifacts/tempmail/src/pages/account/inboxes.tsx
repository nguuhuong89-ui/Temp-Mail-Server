  ...
  return (
    <AccountLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">{t("account.inboxes")}</h1>
          <p className="text-muted-foreground">{t("account.inboxesDesc")}</p>
        </div>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>{t("account.createdAt")}</TableHead>
                <TableHead>{t("account.expiresAt")}</TableHead>
              ...
              {isLoading ? (
                ...
                <TableRow><TableCell colSpan={5} className="h-32 text-center text-muted-foreground">
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <p>{t("account.noInboxes")}</p>
                    <p className="text-xs">{t("account.noInboxesHint")}</p>
                  </div>
                </TableCell></TableRow>
              ) : (
                data.map((i) => {
